...
* [Obtain p-values and confidence intervals for coefficients of a wide range of regression models.](https://mthulin.github.io/boot.pval/articles/boot_summary.html)
* [Perform one and two-sample bootstrap tests of location, with accompanying confidence intervals.](https://mthulin.github.io/boot.pval/articles/boot_t_test.html)
* [Create custom bootstrap tests.](https://mthulin.github.io/boot.pval/articles/custom_tests.html)
