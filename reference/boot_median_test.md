...
Performs one- and two-sample bootstrap median tests and computes the
...
- conf.int:
  ...
  a bootstrap confidence interval for the median appropriate to the
  specified alternative hypothesis.

- estimate:

  the estimated median or difference in medians depending on whether it
  was a one-sample test or a two-sample test.

- null.value:

  the specified hypothesized value of the median or median difference
...
3.12 in Hall (1992). This function computes p-values for the Median Test
in this way. The approach relies on the fact that:
